...
--data "{\"text\": \"Please review job ${BUILD_NUMBER}\",\"attachments\": [{\"fallback\": \"You does not have permissions to approve\",\"callback_id\": \"jenkins_approval\",\"color\": \"#3AA3E3\",\"attachment_type\": \"default\",\"actions\": [{\"name\": \"approval\",\"text\": \"Approve\",\"type\": \"button\",\"value\": \"${BUILD_NUMBER}\"},{\"name\": \"approval\",\"text\": \"Decline\",\"type\": \"button\",\"value\": \"${BUILD_NUMBER}\"}]}]}"
